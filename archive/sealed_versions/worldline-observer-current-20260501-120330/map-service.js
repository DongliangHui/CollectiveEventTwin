(function () {
  ...
  function popupHtml(properties) {
    ...
    return `
      <div class="map-popup-card">
        ...
        <a href="data-hub.html?regionId=${encodeURIComponent(properties.regionId || "")}&mainlineId=${encodeURIComponent(mainlineId)}&signalId=SIG-001&featureId=${encodeURIComponent(properties.featureId || "")}">查看详情</a>
      </div>
    `;
  }
  ...
  function initRiskMap(options) {
    ...
    function addSourcesAndLayers() {
      ...
      addSourceIfMissing(map, "shipping-routes", layers.shippingRoutes);
      ...
      ["risk-hotspot-core", "risk-hotspot-pulse", "event-points", "shipping-routes", "impact-points"].forEach(layerId => {
